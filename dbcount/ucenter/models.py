#!/usr/bin/env python3
# -*- coding:utf-8 -*-
#Created on 2017-11-20 by Author:GuoLikai
#自定义用户认证
...
class UserProfile(AbstractBaseUser):
    ...
    token = models.CharField(u'token', max_length=128, default='test', blank=True, null=True)
    #default表示设置Token默认值：'test'
    department = models.CharField(u'部门', max_length=32, default=u'运维部', blank=True, null=True)
    ...
    remark = models.TextField(u'备注', blank=True, null=True, default=None)
