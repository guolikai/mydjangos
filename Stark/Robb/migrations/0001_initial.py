# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-05-23 04:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('host_alive', models.IntegerField(default=30, verbose_name='主机状态存活间隔')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('has_sub_service', models.BooleanField(default=False, help_text='如果一个服务还有独立的子服务，选择这个；比如网卡有多个独立的子网卡')),
        ...
        migrations.AddField(
            model_name='action',
            name='triggers',
            field=models.ManyToManyField(blank=True, help_text='想让哪些Trigger出发当前', to='Robb.Trigger'),
        ),
    ]
