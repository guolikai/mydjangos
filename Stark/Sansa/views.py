...
from Sansa import tables
from Sansa import core, models, asset_handle, utils, admin
from Sansa.dashboard import  AssetDashboard
...
def asset_report(request):
    ...
    if request.method == 'POST':
        ...
        return HttpResponse(json.dumps(ass_handler.response))
        # return render(request,'Sansa/asset_report_test.html',{'response':ass_handler.response})
        # else:
        # return HttpResponse(json.dumps(ass_handler.response))
...
def asset_with_no_asset_id(request):
    if request.method == 'POST':
        ...
        # return render(request,'Sansa/acquire_asset_id_test.html',{'response':res})
...
def new_assets_approval(request):
    if request.method == 'POST':
        ...
        return render(request, 'Sansa/new_assets_approval.html',
        ...
        return render(request, 'Sansa/new_assets_approval.html', {'new_assets': new_assets})

def asset_report_test(request):
    return render(request, 'Sansa/asset_report_test.html')

@login_required
def acquire_asset_id_test(request):
    return render(request, 'Sansa/acquire_asset_id_test.html')
...
def asset_list(request):
    ...
    return render(request, 'Sansa/assets.html', {'table_obj': table_obj,
                                                  'paginator': paginator})
...
def asset_category(request):
    ...
    if request.is_ajax():
        ...
        return render(request, 'Sansa/asset_category.html', {'category_type': category_type})
...
def asset_detail(request, asset_id):
    if request.method == "GET":
        try:
            ...
            return render(request, 'Sansa/asset_detail.html', {'error': e})
        return render(request, 'Sansa/asset_detail.html', {"asset_obj": asset_obj})
